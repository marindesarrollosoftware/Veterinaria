...
namespace Veterinaria.Web.Migrations
{
    ...
    [Migration("20200319192725_users")]
    partial class users
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Veterinaria.Web.Data.Entities.Manager", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("Veterinaria.Web.Data.Entities.User", b =>
                {
                    b.Property<string>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("Veterinaria.Web.Data.Entities.User")
                        .WithMany()
            ...
            modelBuilder.Entity("Veterinaria.Web.Data.Entities.Manager", b =>
                {
                    b.HasOne("Veterinaria.Web.Data.Entities.User", "User")
                        .WithMany()
                        .HasForeignKey("UserId");
                });
